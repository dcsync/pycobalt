...
```python
openPreferencesDialog(*args, fork=None, sync=True)
```
...
## openProcessBrowser
```python
openProcessBrowser(*args, fork=None, sync=True)
```
...
## openSOCKSBrowser
```python
openSOCKSBrowser(*args, fork=None, sync=True)
```
...
## openSOCKSSetup
```python
openSOCKSSetup(*args, fork=None, sync=True)
```
...
```python
openScreenshotBrowser(*args, fork=None, sync=True)
```
...
## openScriptConsole
```python
openScriptConsole(*args, fork=None, sync=True)
```
...
## openScriptManager
```python
openScriptManager(*args, fork=None, sync=True)
```
...
```python
openScriptedWebDialog(*args, fork=None, sync=True)
```
...
## openServiceBrowser
```python
openServiceBrowser(*args, fork=None, sync=True)
```
...
## openSiteManager
```python
openSiteManager(*args, fork=None, sync=True)
```
...
## openSpawnAsDialog
```python
openSpawnAsDialog(*args, fork=None, sync=True)
```
...
```python
openSpearPhishDialog(*args, fork=None, sync=True)
```
...
```python
openSystemInformationDialog(*args, fork=None, sync=True)
```
...
```python
openSystemProfilerDialog(*args, fork=None, sync=True)
```
...
## openTargetBrowser
```python
openTargetBrowser(*args, fork=None, sync=True)
```
...
## openWebLog
```python
openWebLog(*args, fork=None, sync=True)
```
...
```python
openWindowsDropperDialog(*args, fork=None, sync=True)
```
...
```python
openWindowsExecutableDialog(*args, fork=None, sync=True)
```
...
```python
openWindowsExecutableStage(*args, fork=None, sync=True)
```
...
## pgraph
```python
pgraph(*args, fork=None, sync=True)
```
...
## pivots
```python
pivots(*args, fork=None, sync=True)
```
...
## popup_clear
```python
popup_clear(*args, fork=None, sync=True)
```
...
## powershell
```python
powershell(*args, fork=None, sync=True)
```
...
```python
powershell_encode_oneliner(*args, fork=None, sync=True)
```
...
```python
powershell_encode_stager(*args, fork=None, sync=True)
```
...
## pref_get
```python
pref_get(*args, fork=None, sync=True)
```
...
## pref_get_list
```python
pref_get_list(*args, fork=None, sync=True)
```
...
## pref_set
```python
pref_set(*args, fork=None, sync=True)
```
...
## pref_set_list
```python
pref_set_list(*args, fork=None, sync=True)
```
...
## previousTab
```python
previousTab(*args, fork=None, sync=True)
```
...
## privmsg
```python
privmsg(*args, fork=None, sync=True)
```
...
## prompt_confirm
```python
prompt_confirm(*args, fork=None, sync=True)
```
...
```python
prompt_directory_open(*args, fork=None, sync=True)
```
...
## prompt_file_open
```python
prompt_file_open(*args, fork=None, sync=True)
```
...
## prompt_file_save
```python
prompt_file_save(*args, fork=None, sync=True)
```
...
## prompt_text
```python
prompt_text(*args, fork=None, sync=True)
```
...
## range
```python
range(*args, fork=None, sync=True)
```
...
## removeTab
```python
removeTab(*args, fork=None, sync=True)
```
...
## resetData
```python
resetData(*args, fork=None, sync=True)
```
...
## sbrowser
```python
sbrowser(*args, fork=None, sync=True)
```
...
## screenshots
```python
screenshots(*args, fork=None, sync=True)
```
...
## script_resource
```python
script_resource(*args, fork=None, sync=True)
```
...
## separator
```python
separator(*args, fork=None, sync=True)
```
...
## services
```python
services(*args, fork=None, sync=True)
```
...
## shellcode
```python
shellcode(*args, fork=None, sync=True)
```
...
## showVisualization
```python
showVisualization(*args, fork=None, sync=True)
```
...
## show_error
```python
show_error(*args, fork=None, sync=True)
```
...
## show_message
```python
show_message(*args, fork=None, sync=True)
```
...
## site_host
```python
site_host(*args, fork=None, sync=True)
```
...
## site_kill
```python
site_kill(*args, fork=None, sync=True)
```
...
## sites
```python
sites(*args, fork=None, sync=True)
```
...
```python
ssh_command_describe(*args, fork=None, sync=True)
```
...
## ssh_command_detail
```python
ssh_command_detail(*args, fork=None, sync=True)
```
...
```python
ssh_command_register(*args, fork=None, sync=True)
```
...
## ssh_commands
```python
ssh_commands(*args, fork=None, sync=True)
```
...
## str_chunk
```python
str_chunk(*args, fork=None, sync=True)
```
...
## str_decode
```python
str_decode(*args, fork=None, sync=True)
```
...
## str_encode
```python
str_encode(*args, fork=None, sync=True)
```
...
## str_xor
```python
str_xor(*args, fork=None, sync=True)
```
...
## sync_download
```python
sync_download(*args, fork=None, sync=True)
```
...
## targets
```python
targets(*args, fork=None, sync=True)
```
...
## tbrowser
```python
tbrowser(*args, fork=None, sync=True)
```
...
## tokenToEmail
```python
tokenToEmail(*args, fork=None, sync=True)
```
...
## transform
```python
transform(*args, fork=None, sync=True)
```
...
## transform_vbs
```python
transform_vbs(*args, fork=None, sync=True)
```
...
## tstamp
```python
tstamp(*args, fork=None, sync=True)
```
...
## url_open
```python
url_open(*args, fork=None, sync=True)
```
...
## users
```python
users(*args, fork=None, sync=True)
```
...
## vpn_interface_info
```python
vpn_interface_info(*args, fork=None, sync=True)
```
...
## vpn_interfaces
```python
vpn_interfaces(*args, fork=None, sync=True)
```
...
## vpn_tap_create
```python
vpn_tap_create(*args, fork=None, sync=True)
```
...
## vpn_tap_delete
```python
vpn_tap_delete(*args, fork=None, sync=True)
```
...
## agApplications
```python
agApplications(*args, fork=None, sync=True)
```
...
## agC2info
```python
agC2info(*args, fork=None, sync=True)
```
...
## agCredentials
```python
agCredentials(*args, fork=None, sync=True)
```
...
## agServices
```python
agServices(*args, fork=None, sync=True)
```
...
## agSessions
```python
agSessions(*args, fork=None, sync=True)
```
...
## agTargets
```python
agTargets(*args, fork=None, sync=True)
```
...
## agTokens
```python
agTokens(*args, fork=None, sync=True)
```
...
## attack_describe
```python
attack_describe(*args, fork=None, sync=True)
```
...
## attack_detect
```python
attack_detect(*args, fork=None, sync=True)
```
...
## attack_mitigate
```python
attack_mitigate(*args, fork=None, sync=True)
```
...
## attack_name
```python
attack_name(*args, fork=None, sync=True)
```
...
## attack_tactics
```python
attack_tactics(*args, fork=None, sync=True)
```
...
## attack_url
```python
attack_url(*args, fork=None, sync=True)
```
...
## bookmark
```python
bookmark(*args, fork=None, sync=True)
```
...
## describe
```python
describe(*args, fork=None, sync=True)
```
...
## kvtable
```python
kvtable(*args, fork=None, sync=True)
```
...
## landscape
```python
landscape(*args, fork=None, sync=True)
```
...
## layout
```python
layout(*args, fork=None, sync=True)
```
...
## list_unordered
```python
list_unordered(*args, fork=None, sync=True)
```
...
## nobreak
```python
nobreak(*args, fork=None, sync=True)
```
...
## output
```python
output(*args, fork=None, sync=True)
```
...
## p_formatted
```python
p_formatted(*args, fork=None, sync=True)
```
...
## table
```python
table(*args, fork=None, sync=True)
```
...
## print
```python
print(*args, fork=None, sync=True)
```
...
## println
```python
println(*args, fork=None, sync=True)
```
...
## printAll
```python
printAll(*args, fork=None, sync=True)
```
...
## debug
```python
debug(*args, fork=None, sync=True)
```
...
## command
```python
command(*args, fork=None, sync=True)
```
...
## casti
```python
casti(*args, fork=None, sync=True)
```
...
## typeOf
```python
typeOf(*args, fork=None, sync=True)
```
...
## systemProperties
```python
systemProperties(*args, fork=None, sync=True)
```
