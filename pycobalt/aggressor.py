...
def agApplications(*args, fork=False):
    r"""
    ...
    return engine.call('agApplications', args, fork=fork)


def agC2info(*args, fork=False):
    r"""
    Documentation from https://www.cobaltstrike.com/aggressor-script/rfunctions.html:
    ...
    return engine.call('agC2info', args, fork=fork)


def agCredentials(*args, fork=False):
    r"""
    Documentation from https://www.cobaltstrike.com/aggressor-script/rfunctions.html:
    ...
    return engine.call('agCredentials', args, fork=fork)


def agServices(*args, fork=False):
    r"""
    Documentation from https://www.cobaltstrike.com/aggressor-script/rfunctions.html:
    ...
    return engine.call('agServices', args, fork=fork)


def agSessions(*args, fork=False):
    r"""
    Documentation from https://www.cobaltstrike.com/aggressor-script/rfunctions.html:
    ...
    return engine.call('agSessions', args, fork=fork)


def agTargets(*args, fork=False):
    r"""
    Documentation from https://www.cobaltstrike.com/aggressor-script/rfunctions.html:
    ...
    return engine.call('agTargets', args, fork=fork)


def agTokens(*args, fork=False):
    r"""
    Documentation from https://www.cobaltstrike.com/aggressor-script/rfunctions.html:
    ...
    return engine.call('agTokens', args, fork=fork)


def attack_describe(*args, fork=False):
    r"""
    Documentation from https://www.cobaltstrike.com/aggressor-script/rfunctions.html:
    ...
    return engine.call('attack_describe', args, fork=fork)


def attack_detect(*args, fork=False):
    r"""
    Documentation from https://www.cobaltstrike.com/aggressor-script/rfunctions.html:
    ...
    return engine.call('attack_detect', args, fork=fork)


def attack_mitigate(*args, fork=False):
    r"""
    Documentation from https://www.cobaltstrike.com/aggressor-script/rfunctions.html:
    ...
    return engine.call('attack_mitigate', args, fork=fork)


def attack_name(*args, fork=False):
    r"""
    Documentation from https://www.cobaltstrike.com/aggressor-script/rfunctions.html:
    ...
    return engine.call('attack_name', args, fork=fork)


def attack_tactics(*args, fork=False):
    r"""
    Documentation from https://www.cobaltstrike.com/aggressor-script/rfunctions.html:
    ...
    return engine.call('attack_tactics', args, fork=fork)


def attack_url(*args, fork=False):
    r"""
    Documentation from https://www.cobaltstrike.com/aggressor-script/rfunctions.html:
    ...
    return engine.call('attack_url', args, fork=fork)


def bookmark(*args, fork=False):
    r"""
    Documentation from https://www.cobaltstrike.com/aggressor-script/rfunctions.html:
    ...
    return engine.call('bookmark', args, fork=fork)


def br(*args, fork=False):
    r"""
    Documentation from https://www.cobaltstrike.com/aggressor-script/rfunctions.html:
    ...
    return engine.call('br', args, fork=fork)


def describe(*args, fork=False):
    r"""
    Documentation from https://www.cobaltstrike.com/aggressor-script/rfunctions.html:
    ...
    return engine.call('describe', args, fork=fork)


def h1(*args, fork=False):
    r"""
    Documentation from https://www.cobaltstrike.com/aggressor-script/rfunctions.html:
    ...
    return engine.call('h1', args, fork=fork)


def h2(*args, fork=False):
    r"""
    Documentation from https://www.cobaltstrike.com/aggressor-script/rfunctions.html:
    ...
    return engine.call('h2', args, fork=fork)


def h3(*args, fork=False):
    r"""
    Documentation from https://www.cobaltstrike.com/aggressor-script/rfunctions.html:
    ...
    return engine.call('h3', args, fork=fork)


def h4(*args, fork=False):
    r"""
    Documentation from https://www.cobaltstrike.com/aggressor-script/rfunctions.html:
    ...
    return engine.call('h4', args, fork=fork)


def kvtable(*args, fork=False):
    r"""
    Documentation from https://www.cobaltstrike.com/aggressor-script/rfunctions.html:
    ...
    return engine.call('kvtable', args, fork=fork)


def landscape(*args, fork=False):
    r"""
    Documentation from https://www.cobaltstrike.com/aggressor-script/rfunctions.html:
    ...
    return engine.call('landscape', args, fork=fork)


def layout(*args, fork=False):
    r"""
    Documentation from https://www.cobaltstrike.com/aggressor-script/rfunctions.html:
    ...
    return engine.call('layout', args, fork=fork)


def list_unordered(*args, fork=False):
    r"""
    Documentation from https://www.cobaltstrike.com/aggressor-script/rfunctions.html:
    ...
    return engine.call('list_unordered', args, fork=fork)


def nobreak(*args, fork=False):
    r"""
    Documentation from https://www.cobaltstrike.com/aggressor-script/rfunctions.html:
    ...
    return engine.call('nobreak', args, fork=fork)


def output(*args, fork=False):
    r"""
    Documentation from https://www.cobaltstrike.com/aggressor-script/rfunctions.html:
    ...
    return engine.call('output', args, fork=fork)


def p(*args, fork=False):
    r"""
    Documentation from https://www.cobaltstrike.com/aggressor-script/rfunctions.html:
    ...
    return engine.call('p', args, fork=fork)


def p_formatted(*args, fork=False):
    r"""
    Documentation from https://www.cobaltstrike.com/aggressor-script/rfunctions.html:
    ...
    return engine.call('p_formatted', args, fork=fork)


def table(*args, fork=False):
    r"""
    Documentation from https://www.cobaltstrike.com/aggressor-script/rfunctions.html:
    ...
    return engine.call('table', args, fork=fork)


def ts(*args, fork=False):
    r"""
    Documentation from https://www.cobaltstrike.com/aggressor-script/rfunctions.html:
    ...
    return engine.call('ts', args, fork=fork)
